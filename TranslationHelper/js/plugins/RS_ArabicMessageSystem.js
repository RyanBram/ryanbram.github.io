...
(() => {
  ...
  function getMessageMode() {
    if (window.LanguageSwitcher && typeof LanguageSwitcher.getCurrentLanguage === 'function') {
  ...
  class ArabicTextAnimator {
    constructor(bitmap, text, x, y, maxWidth, lineHeight) {
      ...
      this.charactersPerFrame = RS.ArabicMessageSystem.Params.textRevealSpeed || 2;
      this.speedPerFrame = this.textLength > 0 ? this.charactersPerFrame / this.textLength : 1;
    }
    ...
    initialize() {
      ...
      tempBitmap.drawText(wrappedText, 0, 0, this.maxWidth, this.lineHeight, "left");
  ...
  const alias_Window_Base_processNormalCharacter = Window_Base.prototype.processNormalCharacter;
  ...
  const alias_Window_Message_standardFontSize = Window_Message.prototype.standardFontSize;
  ...
  Window_Message.prototype.processNormalCharacter = function (textState) {
    ...
    if (!this._showFast && Graphics.isWebGL() && getMessageMode() === 'arabic') {
  ...
  const alias_Window_Message_terminateMessage = Window_Message.prototype.terminateMessage;
