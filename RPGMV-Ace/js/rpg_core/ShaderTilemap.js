...
ShaderTilemap.prototype.render = function (renderer) {
  ...
  PIXI.Container.prototype.render.call(this, renderer); // Show map
};
...
ShaderTilemap.prototype.updateTransform = function () {
  if (Graphics._renderer) {
    this._hackRenderer(Graphics._renderer);
  }
  if (this.roundPixels) {
  ...
  this._sortChildren();
  PIXI.Container.prototype.updateTransform.call(this); // show map object
};
