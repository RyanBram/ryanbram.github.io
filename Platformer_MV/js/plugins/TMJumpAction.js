/*:
 * @plugindesc Turns the map scene into something resembling an action game.
 * For usage instructions and more, please refer to the distribution site.
 * @author tomoaky (http://hikimoki.sakura.ne.jp/)
 *
 * @param gravity
 * @type string
 * @desc Strength of gravity.
 * Default: 0.004
 * @default 0.004
 *
 * @param friction
 * @type string
 * @desc Strength of friction for normal terrain and events.
 * Default: 0.001
 * @default 0.001
 *
 * @param tileMarginTop
 * @type string
 * @desc How much to shift the coordinates used for collision detection with terrain upwards.
 * Default: 0.5
 * @default 0.5
 *
 * @param stepsForTurn
 * @type number
 * @desc How many steps it takes for one turn to pass.
 * Default: 20
 * @default 20
 *
 * @param allDeadEvent
 * @type number
 * @desc Common event number to run when all characters are defeated.
 * Default: 0
 * @default 0
 *
 * @param guardState
 * @type state
 * @desc State number to be treated as the guard state.
 * Default: 2
 * @default 2
 *
 * @param guardMoveRate
 * @type number
 * @desc Movement speed adjustment for the guard state (%).
 * Default: 25
 * @default 25
 *
 * @param eventCollapse
 * @type boolean
 * @desc Use collapsing effects when events are defeated in battle.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param hpGauge
 * @type boolean
 * @desc Enable the HP gauge display at the character's feet.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param floorDamage
 * @type number
 * @desc Damage received from damage floors.
 * Default: 10
 * @default 10
 *
 * @param damageFallRate
 * @type number
 * @desc Multiplier for fall damage.
 * Default: 10
 * @default 10
 *
 * @param damageFallHeight
 * @type number
 * @desc Height at which fall damage is incurred.
 * Default: 5
 * @default 5
 *
 * @param flickWeight
 * @type number
 * @desc Difference in weight needed to flick an object.
 * Default: 1 (0 means objects of the same weight can be flicked)
 * @default 1
 *
 * @param flickSkill
 * @type skill
 * @desc Skill number used for flicking damage calculation.
 * Default: 1 (0 means no damage)
 * @default 1
 *
 * @param stageRegion
 * @type number
 * @desc Region number to treat as a platform.
 * Default: 60
 * @default 60
 *
 * @param wallRegion
 ...
 * @type number
 * @desc Region number for walls that cannot be wall-jumped on.
 * Default: 62
 * @default 62
 *
 * @param slipFloorRegion
 * @type number
 * @desc Region number to treat as slippery floor.
 * Default: 63
 * @default 63
 *
 * @param roughFloorRegion
 * @type number
 * @desc Region number to treat as a floor that reduces movement speed.
 * Default: 64
 * @default 64
 *
 * @param marshFloorRegion
 * @type number
 * @desc Region number to treat as an impassable floor.
 * Default: 65
 * @default 65
 *
 ...
 * @param levelupPopup
 * @type string
 * @desc Popup displayed when leveling up.
 * Default: LEVEL UP!!
 * @default LEVEL UP!!
 *
 * @param levelupAnimationId
 * @desc Animation number displayed when leveling up.
 * Default: 46
 * @default 46
 * @require 1
 * @type animation
 ...
 * @param attackToOk
 * @type boolean
 * @desc Use the attack button as the menu's confirm button.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param jumpToCancel
 * @type boolean
 * @desc Use the jump button as the menu's cancel button.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param useEventSeSwim
 * @type boolean
 * @desc Apply the water entry sound effect to events when entering water.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param jumpSe
 * @desc Filename of the jump sound effect.
 * Default: Crossbow
 * @default Crossbow
 * @require 1
 * @dir audio/se/
 ...
 * @param jumpSeParam
 * @type string
 * @desc Parameters for the jump sound effect.
 * Default: {"volume":90, "pitch":100, "pan":0}
 * @default {"volume":90, "pitch":100, "pan":0}
 *
 * @param dashSe
 * @desc Filename of the dash sound effect.
 * Default: Wind4
 * @default Wind4
 * @require 1
 * @dir audio/se/
 ...
 * @param dashSeParam
 * @type string
 * @desc Parameters for the dash sound effect.
 * Default: {"volume":90, "pitch":50, "pan":0}
 * @default {"volume":90, "pitch":50, "pan":0}
 *
 * @param flickSe
 * @desc Filename of the flick sound effect.
 * Default: Damage1
 * @default Damage1
 * @require 1
 * @dir audio/se/
 ...
 * @param flickSeParam
 * @type string
 * @desc Parameters for the flick sound effect.
 * Default: {"volume":90, "pitch":100, "pan":0}
 * @default {"volume":90, "pitch":100, "pan":0}
 *
 * @param swimSe
 * @desc Filename of the swim sound effect.
 * Default: Water1
 * @default Water1
 * @require 1
 * @dir audio/se/
 ...
 * @param swimSeParam
 * @type string
 * @desc Parameters for the swim sound effect.
 * Default: {"volume":90, "pitch":100, "pan":0}
 * @default {"volume":90, "pitch":100, "pan":0}
 *
 * @param changeSe
 * @desc Filename of the character switch sound effect.
 * Default: Sword1
 * @default Sword1
 * @require 1
 * @dir audio/se/
 ...
 * @param changeSeParam
 * @type string
 * @desc Parameters for the character switch sound effect.
 * Default: {"volume":90, "pitch":100, "pan":0}
 * @default {"volume":90, "pitch":100, "pan":0}
 *
 * @param carrySe
 * @desc Filename of the event carrying sound effect.
 * Default: Cancel1
 * @default Cancel1
 * @require 1
 * @dir audio/se/
 ...
 * @param carrySeParam
 * @type string
 * @desc Parameters for the event carrying sound effect.
 * Default: {"volume":90, "pitch":70, "pan":0}
 * @default {"volume":90, "pitch":70, "pan":0}
 *
 * @param hurlSe
 * @desc Filename of the event throwing sound effect.
 * Default: Evasion1
 * @default Evasion1
 * @require 1
 * @dir audio/se/
 ...
 * @param hurlSeParam
 * @type string
 * @desc Parameters for the event throwing sound effect.
 * Default: {"volume":90, "pitch":70, "pan":0}
 * @default {"volume":90, "pitch":70, "pan":0}
 *
 * @param guardSe
 * @desc Filename of the guard sound effect.
 * Default: Equip1
 * @default Equip1
 * @require 1
 * @dir audio/se/
 ...
 * @param guardSeParam
 * @type string
 * @desc Parameters for the guard sound effect.
 ...
 * @type number
 * @desc Maximum number of event bullets.
 * Default: 256
 * @default 256
 *
 * @param weaponSprite
 * @type boolean
 * @desc Display weapon image when firing bullets.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param autoDamageSe
 * @type boolean
 * @desc Automatically play sound effects upon landing.
 * Default: ON (false = OFF / true = ON)
 * @default true
 *
 * @param bulletTypeName1
 * @desc Filename of bullet type 1's image.
 * Default: Bullet1
 * @default Bullet1
 * @require 1
 * @dir img/system/
 ...
 * @desc Filename of bullet type 2's image.
 * Default: Bullet1
 * @default Bullet1
 * @require 1
 * @dir img/system/
 ...
 * @desc Filename of bullet type 3's image.
 * Default: Bullet1
 * @default Bullet1
 * @require 1
 * @dir img/system/
 ...
 * @desc Filename of bullet type 4's image.
 * Default: Bullet1
 * @default Bullet1
 * @require 1
 * @dir img/system/
 ...
 * @type string
 * @desc Collision sizes for each bullet type.
 * Default: 6,6,6,6
 * @default 6,6,6,6
 *
 * @param attackKey
 * @type string
 * @desc Key used for player's bullet firing.
 * Default: Z
 * @default Z
 *
 * @param jumpKey
 * @type string
 * @desc Key used for player's jump.
 * Default: X
 * @default X
 *
 * @param dashKey
 * @type string
 * @desc Key used for player's dash.
 * Default: C
 * @default C
 *
 * @param padButtons
 * @type string
 * @desc Codes for the pad buttons used.
 * Default: ok,cancel,menu,shift,attack,jump,pageup,pagedown
 * @default ok,cancel,menu,shift,attack,jump,pageup,pagedown
 *
 * @param padButtonNames
 * @type string
 * @desc Names for the pad buttons.
 * Set button names in the same order as padButtons.
 * @default Confirm,Cancel,Menu,Dash,Attack,Jump,Change Character (Previous),Change Character (Next)
 *
 * @param defaultPadButtons
 * @type string
 * @desc Default configuration for pad buttons.
 * Default: Set codes for buttons 1 to 12.
 * @default cancel,ok,shift,jump,pageup,pagedown,attack,menu,menu,menu,menu,menu
 *
 * @param padConfigCommand
 * @type string
 * @desc Command name for pad button configuration (leave blank to disable).
 * Default: Configure Pad Buttons
 * @default Configure Pad Buttons
 *
 * @param stepAnimeConstantA
 * @type string
 * @desc Constant for step animation speed A.
 * Default: 0.1
 * @default 0.1
 *
 * @param stepAnimeConstantB
 * @type string
 * @desc Constant for step animation speed B.
 * Default: 300
 * @default 300
 *
 ...
 * Usage:
 *
 *   Please refer to the distribution site for detailed instructions.
 *
 *   This plugin has been tested with RPG Maker MV Version 1.5.0.
 * 
 *   This plugin is distributed under the MIT license, allowing for commercial use,
 *   modification, redistribution, and more.
 *
 *
 * Notetag Tags (Actor, Equipment, State):
 * 
 *   <move_speed:0.05>        # Walking speed
 *   <jump_speed:0.14>        # Jumping ability
 *   <swim_speed:0.02>        # Swimming speed
 *   <ladder_speed:0.04>      # Ladder climbing speed
 *   <accele:0.003>           # Walking acceleration
 *   <ladder_accele:0.003>    # Ladder climbing acceleration
 *   <jump_input:0>           # Additional jump input time
 *   <swim_jump:0.1>          # Underwater jump strength
 ...
 *   <dash_delay:30>          # Dash recovery time
 *   <dash_mp_cost:0>         # MP cost for dashing
 *   <fall_guard:50>          # Falling damage resistance
 *   <guard_speed:15>         # Transition speed to guard state
 *   <invincible_time:30>     # Invincibility time after taking damage
 *   <shot_way:1>             # Number of bullets fired simultaneously
 *   <shot_space:0.2>         # Space between bullets (in radians)
 *   <shot_speed:0.07>        # Bullet movement speed
 *   <shot_count:30>          # Bullet lifespan
 *   <shot_type:1>            # Bullet type
 *   <shot_index:0>           # Bullet image index
 *   <shot_skill:1>           # Bullet skill ID
 *   <shot_delay:10>          # Cooldown time after firing
 ...
 * Notetag Tags (Event):
 * 
 *   <w:0.375>                # Collision box width (center to left/right edge)
 *   <h:0.75>                 # Collision box height (bottom to top edge)
 *   <enemy:1>                # Battler (enemy number)
 *   <dead:A>                 # Self-switch when battler is defeated
 *   <repop:300>              # Time until respawn (in frames)
 *   <lift>                   # Lift attribute
 *   <weight:1>               # Weight
 ...
 * Notetag Tags (Skill):
 * 
 *   <bullet_anime:67>        # Animation played upon bullet impact
 *   <map_through>            # Bullets pass through terrain
 *   <map_reflect>            # Bullets bounce off terrain without disappearing
 * 
 *   <time_bomb:6 0 0.2 45 1 0 1>
 *     When bullets expire, they create new bullets.
 *     Set parameters for the plugin command 'nallShot' from 'n' to 'skillId'.
 *
 * 
 * Plugin Commands:
 * 
 *   actGainHp -1 -5          # Deal 5 damage to the player.
 *   actGainHp 1 -100         # Deal 100 damage to event 1.
 *   actHp 1 2                # Assign event 1's HP to game variable 2.
 *   actForceX -1 0.1         # Forcefully set the player's X velocity to 0.1.
 *   actForceY 1 -0.15        # Forcefully set event 1's Y velocity to -0.15.
 *   actForceStop -1          # Forcefully set the player's velocity to 0.
 *   actChangeActor 2         # Change the controlled character to actor 2.
 *   actHideHpGauge           # Hide the foot HP gauge
 *   actShowHpGauge           # Show the foot HP gauge
 * 
 *   actPopup -1 Text #ff0000
 *     Display red text as a popup on the player.
 * 
 *   nwayShot eventId n space angle speed count type index skillId
 *     eventId: Event number that fires the bullets (-1 for player)
 *     n:       Number of bullets fired simultaneously
 *     space:   Space between bullets (in radians)
 *     angle:   Firing direction (in radians)
 ...
 *     Similar to nwayShot but automatically adds the direction towards the player
 *     to the angle (in radians). If angle is 0, it automatically targets the player.
 *
 *   nallShot eventId n angle speed count type index skillId
 *     Fires bullets in all directions, automatically setting the spacing between them.
 *
 *   nallAim eventId n space angle speed count type index skillId
 *     Aiming version of nallShot that targets the player automatically.
 */
